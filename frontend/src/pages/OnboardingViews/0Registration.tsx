...
interface RegistrationProps {
  data: (data: string) => void; // Function to set onboarding data
  // Function passed from parent (e.g., App) to change the view
  onViewChange: (view: "login" | "register" | "dashboard") => void;
}

export default function Registration({ data, onViewChange }: RegistrationProps) {
    ...
    return (
        <div className="w-full max-w-md bg-red-500">
